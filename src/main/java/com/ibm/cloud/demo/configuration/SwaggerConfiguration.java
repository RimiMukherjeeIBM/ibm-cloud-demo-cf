package com.ibm.cloud.demo.configuration;
...
/*
    ...
    public Docket getDocket() {
        return new Docket(DocumentationType.SWAGGER_2).select().paths(PathSelectors.ant("/customer/**")).apis(RequestHandlerSelectors.basePackage("com.ibm.cloud.demo")).build()
                .apiInfo(getApiInfo());
    }
